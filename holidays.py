...
#     """Возвращает список строк-заголовков праздников на СЕГОДНЯ по Москве
#        из RSS «Ежедневник» Calend.ru.
#     """
#     url = "https://www.calend.ru/calendar/feed/"
#     resp = requests.get(url, headers=HEADERS, timeout=15)
#     feed = feedparser.parse(resp.content)
...
# def get_holidays_for_date(target: datetime.date) -> list[str]:
#     """
#     Возвращает список заголовков праздников из RSS «Ежедневник» за указанную дату (по Москве).
#     """
#     url = "https://www.calend.ru/calendar/feed/"
#     resp = requests.get(url, headers=HEADERS, timeout=15)
#     feed = feedparser.parse(resp.content)
